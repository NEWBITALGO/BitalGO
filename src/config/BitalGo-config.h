/* src/config/BitalGo-config.h.  Generated from BitalGo-config.h.in by configure.  */
/* src/config/BitalGo-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_STRING "BitalGo Core 2.0.1"
