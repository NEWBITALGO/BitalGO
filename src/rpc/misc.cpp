...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total BitalGo balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zALGsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zALG denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zALG denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zALG denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zALG denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zALG denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zALG denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zALG denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zALG denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zALG denominations\n"
            "  }\n"
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zALGObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zALGObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zALGsupply", zALGObj));
...
UniValue mnsync(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1 || (strMode != "status" && strMode != "next")) {
        throw runtime_error(
...
#ifdef ENABLE_WALLET
        // Case 1: ALG address and we have full public key:
