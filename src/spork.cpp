...
// Copyright (c) 2016-2018 The ALG developers
...
// ALG: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_NEW_PROTOCOL_ENFORCEMENT) r = SPORK_17_NEW_PROTOCOL_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_NEW_PROTOCOL_ENFORCEMENT") return SPORK_17_NEW_PROTOCOL_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_NEW_PROTOCOL_ENFORCEMENT) return "SPORK_17_NEW_PROTOCOL_ENFORCEMENT";
