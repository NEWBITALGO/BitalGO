...
#ifndef ALG_ZALGWALLET_H
#define ALG_ZALGWALLET_H
...
public:
    CzALGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZALG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZALG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
