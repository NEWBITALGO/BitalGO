...
#ifndef ALG_ZALGTRACKER_H
#define ALG_ZALGTRACKER_H
...
public:
    CzALGTracker(std::string strWalletFile);
    ~CzALGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzALGWallet* zALGWallet = NULL);
