...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeBitalGoAmount"))
        settings.setValue("nAnonymizeBitalGoAmount", 1000);

    nAnonymizeBitalGoAmount = settings.value("nAnonymizeBitalGoAmount").toLongLong();
...
QVariant OptionsModel::data(const QModelIndex& index, int role) const
{
    if (role == Qt::EditRole) {
        ...
        case AnonymizeBitalGoAmount:
            return QVariant(nAnonymizeBitalGoAmount);
        case Listen:
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case HideOrphans:
            ...
            break;
        case AnonymizeBitalGoAmount:
            nAnonymizeBitalGoAmount = value.toInt();
            settings.setValue("nAnonymizeBitalGoAmount", nAnonymizeBitalGoAmount);
            emit anonymizeBitalGoAmountChanged(nAnonymizeBitalGoAmount);
            break;
        case CoinControlFeatures:
