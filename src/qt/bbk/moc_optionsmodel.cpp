...
QT_MOC_LITERAL(8, 133, 29), // "anonymizeBitalGoAmountChanged"
QT_MOC_LITERAL(9, 163, 26), // "coinControlFeaturesChanged"
QT_MOC_LITERAL(10, 190, 23), // "hideZeroBalancesChanged"
QT_MOC_LITERAL(11, 214, 18) // "hideOrphansChanged"
    ...
    "anonymizeBitalGoAmountChanged\0"
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->anonymizeBitalGoAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (OptionsModel::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsModel::anonymizeBitalGoAmountChanged)) {
                *result = 5;
                return;
            }
        }
...
// SIGNAL 5
void OptionsModel::anonymizeBitalGoAmountChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
