                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitalGo Core") + " - ";
#ifdef ENABLE_WALLET
...
//    labelAutoMintIcon->setMaximumSize(STATUSBAR_ICONSIZE, STATUSBAR_ICONSIZE);
    ...
    labelConnectionsIcon->setStyleSheet(".QPushButton { background-color: #2abff1; padding-left: 10px; padding-right: 10px; border-radius: 15px;}");
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ALG address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BitalGo: URIs)"));
...
//    connect(governanceAction, SIGNAL(triggered()), this, SLOT(gotoGovernancePage()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitalGo Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitalGo Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for ALG"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ALG addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ALG addresses"));
    ...
    openAction->setStatusTip(tr("Open a ALG: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitalGo Core help message to get a list with possible ALG command-line options"));
...
//        toolbar->addAction(governanceAction);
        ...
        // emove unused icon in upper left corner
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitalGo Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ALG network", "", count));
}
...
{
    QString strTitle = tr("BitalGo Core"); // default title
