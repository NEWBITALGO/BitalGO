...
public:
    ...
    {
        labelOverviewHeaderLeft->setText(QApplication::translate("ReceiveCoinsDialog", "RECEIVE", nullptr));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label->setToolTip(QApplication::translate("ReceiveCoinsDialog", "Your receiving address. You can copy and use it to receive coins on this wallet. A new one will be generated once it is used.", nullptr));
#endif // QT_NO_TOOLTIP
        label->setText(QApplication::translate("ReceiveCoinsDialog", "&Address:", nullptr));
#ifndef QT_NO_TOOLTIP
        reqAddress->setToolTip(QApplication::translate("ReceiveCoinsDialog", "Your receiving address. You can copy and use it to receive coins on this wallet. A new one will be generated once it is used.", nullptr));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label1->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional amount to request. Leave this empty or zero to not request a specific amount.", nullptr));
#endif // QT_NO_TOOLTIP
        label1->setText(QApplication::translate("ReceiveCoinsDialog", "A&mount:", nullptr));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        label_3->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened. Note: The message will not be sent with the payment over the ALG network.", nullptr));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("ReceiveCoinsDialog", "&Message:", nullptr));
#ifndef QT_NO_TOOLTIP
        reqMessage->setToolTip(QApplication::translate("ReceiveCoinsDialog", "An optional message to attach to the payment request, which will be displayed when the request is opened.<br>Note: The message will not be sent with the payment over the ALG network.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        receivingAddressesButton->setText(QApplication::translate("ReceiveCoinsDialog", "Receiving Addresses", nullptr));
