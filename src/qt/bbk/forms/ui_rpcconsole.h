...
public:
    ...
    QLabel *wallet_customzALGbackuppath_label;
    QLabel *wallet_customzALGbackuppath;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        wallet_customzALGbackuppath_label = new QLabel(tab_repair);
        wallet_customzALGbackuppath_label->setObjectName(QStringLiteral("wallet_customzALGbackuppath_label"));
        wallet_customzALGbackuppath_label->setVisible(false);

        gridLayout_4->addWidget(wallet_customzALGbackuppath_label, 4, 0, 1, 1);

        wallet_customzALGbackuppath = new QLabel(tab_repair);
        wallet_customzALGbackuppath->setObjectName(QStringLiteral("wallet_customzALGbackuppath"));
        wallet_customzALGbackuppath->setCursor(QCursor(Qt::IBeamCursor));
        wallet_customzALGbackuppath->setTextFormat(Qt::PlainText);
        wallet_customzALGbackuppath->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
        wallet_customzALGbackuppath->setVisible(false);

        gridLayout_4->addWidget(wallet_customzALGbackuppath, 4, 1, 1, 3);
    ...
    void retranslateUi(QDialog *RPCConsole)
    {
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the ALG debug log file from the current data directory. This can take a few seconds for large log files.", nullptr));
#endif // QT_NO_TOOLTIP
        ...
        wallet_custombackuppath_label->setText(QApplication::translate("RPCConsole", "Custom Backup Path:", nullptr));
        wallet_custombackuppath->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        wallet_customzALGbackuppath_label->setText(QApplication::translate("RPCConsole", "Custom zALG Backup Path:", nullptr));
        wallet_customzALGbackuppath->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
        wallet_custombackupthreshold_label->setText(QApplication::translate("RPCConsole", "Custom Backups Threshold:", nullptr));
        wallet_custombackupthreshold->setText(QApplication::translate("RPCConsole", "N/A", nullptr));
