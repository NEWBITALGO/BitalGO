...
public:
    ...
    {
        GovernancePage->setWindowTitle(QApplication::translate("GovernancePage", "Form", nullptr));
        labelOverviewHeaderLeft->setText(QApplication::translate("GovernancePage", "GOVERNANCE", nullptr));
        labelOverviewHeaderRight->setText(QString());
        UpdateButton->setText(QApplication::translate("GovernancePage", "Update Proposals", nullptr));
        next_superblock_label->setText(QApplication::translate("GovernancePage", "Next super block:", nullptr));
        next_superblock_value->setText(QApplication::translate("GovernancePage", "0", nullptr));
        blocks_before_super_label->setText(QApplication::translate("GovernancePage", "Blocks to next super block:", nullptr));
        blocks_before_super_value->setText(QApplication::translate("GovernancePage", "0", nullptr));
        time_before_super_label->setText(QApplication::translate("GovernancePage", "Days to budget payout (estimate):", nullptr));
        time_before_super_value->setText(QApplication::translate("GovernancePage", "0", nullptr));
        alloted_budget_label->setText(QApplication::translate("GovernancePage", "Allotted budget:", nullptr));
        alloted_budget_value->setText(QApplication::translate("GovernancePage", "0", nullptr));
        unallocated_budget_label->setText(QApplication::translate("GovernancePage", "Budget left:", nullptr));
        unallocated_budget_value->setText(QApplication::translate("GovernancePage", "0", nullptr));
        masternode_count_label->setText(QApplication::translate("GovernancePage", "Masternodes count:", nullptr));
        masternode_count_value->setText(QApplication::translate("GovernancePage", "0", nullptr));
    } // retranslateUi
