...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a ALG address (e.g. %1)").arg("D7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
{
    // return if URI is not valid or is no ALG: URI
...
void openConfigfile()
{
    ...
    /* Open BitalGo.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "ALG.lnk";
}
