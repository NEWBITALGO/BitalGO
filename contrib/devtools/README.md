...
Setup
---------
Configuring the github-merge tool for the ALG repository is done in the following way:

    git config githubmerge.repository ALG-Project/ALG
...
A script to optimize png files in the ALG
