...
In order to support loading of multiple wallets in BitalGo-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BitalGo.cpp.
...
Changes to BitalGo.cpp
----------------------
BitalGo.cpp is the entry point into BitalGo-qt, and as such, will require some minor modifications to provide hooks for
