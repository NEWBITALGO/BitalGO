...
confused with overall ALG Network Protocol consensus changes.
...
Patches that change ALG consensus rules are considerably more involved than
...
Where a patch set proposes to change the ALG consensus, it must have been
